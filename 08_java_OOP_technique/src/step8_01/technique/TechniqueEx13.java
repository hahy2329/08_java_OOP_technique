...
class OrderDTO{ //DTO : 전송
	...
	public void setDeliveryAddress(String delivertAddress) {
	...
	public String toString() {
		return "OrderDTO [orderId=" + orderId + ", goodsId=" + goodsId + ", goodsNm=" + goodsNm + ", memberId="
				+ memberId + ", deliveryMethod=" + deliveryMethod + ", delivertAddress=" + delivertAddress
